...
#### 3：进入项目根目录
```
cd omega-compute/src/compute-web
```
#### 4：安装项目依赖的库
```
npm install
...
```
#### 8：本地开发mock，比如我们的规则是.ajax结尾的请求都认为是调用后端api的接口，比如：/api/module1/common/user，那么映射到mock文件为/mock/module1_common_user.js，对应的内容类似如下：
```
module.exports = {
    "status" : 200,
    "data": {
